...
function ProfileCard() {
  let Linkdin =
    "https://raw.githubusercontent.com/Abhishek28112002/student_profile_page/decee155c32745fcfa222f69661bd0f1a5e2bdb5/src/Icons/LinkedIn.svg?token=ARHH25NWLL4SJA66RJVD65TFFJORK";
  let Gmail =
    "https://raw.githubusercontent.com/Abhishek28112002/student_profile_page/decee155c32745fcfa222f69661bd0f1a5e2bdb5/src/Icons/Mail.svg?token=ARHH25OPTXEM64WNAHHDVJTFFJOU2";
  return (
    <Card style={{ width: "18rem" }}>
      ...
      <Card.Body>
        ...
        >
          ...
          <div style={{ marginLeft: "5px" }}>
            <a href="mailto:addHttpPrefix(${props.data[1])}" target="_blank">
              <img
                src={Gmail}
                style={{
                  width: "36px",
